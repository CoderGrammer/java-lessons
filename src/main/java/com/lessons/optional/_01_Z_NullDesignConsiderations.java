...
/*
 ...
 - We know that it is lightweight and therefore performant - does not create lots of objects
...
public class _01_Z_NullDesignConsiderations {
     ...
     /*
      ...
      - We cannot say the building is safe just because hazards is null - we need to first be sure what null means in this context
      - This kind of ambiguity is dangerous and needs to be addressed from a design perspective
     */
     void missingValue() {
         ...
         static class Hazards {
             ...
             List<String> getHazards() {
                 if (hazardsCheckStatus == HazardsCheckStatus.NOT_LOADED) {
                     throw new IllegalStateException("Hazards have not yet been loaded. Call isHazardsLoaded() before calling this method");
                 }
                 return hazards;
             }

             void setHazards(List<String> hazards) {
                 Objects.requireNonNull(hazards, "hazards cannot be null. They can be empty list if there are no hazards. Do not call this method with a default value.");
